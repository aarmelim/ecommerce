...
CREATE PROCEDURE sp_addresses_save (IN pidaddress INT(11), IN pidperson INT(11), IN pdesaddress VARCHAR(128), IN pdesnumber VARCHAR(16), IN pdescomplement VARCHAR(32), IN pdescity VARCHAR(32), IN pdesstate VARCHAR(32), IN pdescountry VARCHAR(32), IN pdeszipcode CHAR(8), IN pdesdistrict VARCHAR(32))
BEGIN
...
(9, 'Tricot', '2020-07-25 20:44:38'),
(10, 'blusa', '2020-07-25 20:44:58');
...
(21, 'aarmelim@hotmail.com', 'aarmelim@hotmail.com', 11981207355, '2020-07-25 15:56:45'),
(22, 'Ana Paula Kubota', 'anakubota@hotmail.com', 11984022526, '2020-07-25 15:58:59');
...
(5, 'Smartphone Samsung Galaxy J3 Dual', '679.90', '14.20', '7.10', '0.70', '0.14', 'smartphone-samsung-galaxy-j3', '2017-09-04 21:30:32'),
(11, 'Cardigan', '139.90', '30.00', '5.00', '30.00', '1.00', 'cardigan', '2020-07-25 20:47:10'),
(12, 'Tricot poá manga princesa', '118.00', '30.00', '5.00', '30.00', '1.00', 'tricot-poa-manga-princesa', '2020-07-25 20:48:51');
...
(21, 21, 'aarmelim@hotmail.com', '$2y$12$i1Te/ehPH0Y9BiWfnu1ijuF25tFxXHxHHs2mIfXT77byD8D6WrkE.', 1, '2020-07-25 15:56:45'),
(22, 22, 'anakubota@hotmail.com', '$2y$12$InCJT4cBeBGPScb0wnVryO/3MQCMa9qc2nYJQSM4.VQE/pBN9nrEi', 1, '2020-07-25 15:58:59');
...
--
ALTER TABLE tb_cartsproducts
  MODIFY idcartproduct int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE tb_persons
  MODIFY idperson int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
