...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            De
            <address>
                <strong>Anna K Store</strong><br>
                São Paulo - SP<br>
                <a target="_blank" href="https://api.whatsapp.com/send?phone=5511984022526&text=Ola">WhatsApp: (11) 98120-7355</a><br>
                E-mail: storeannak@gmail.com.br
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
