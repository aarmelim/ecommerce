...
use \aarmelim\Model\OrderStatus;
...
$app->get("/cart/:idproduct/add", function($idproduct){
	...
	$cart = Cart::getFromSession(); //esse método tem a inteligência de me devolver o que ja existe ou de criar um novo quando ainda não tiver, mas sempre devolve um carrinho.
...
$app->post("/profile", function(){
	...
	$_POST['despassword'] = $user->getdespassword(); // com se ele sempre alterasse a senha pela mesma
	$_POST['deslogin'] = $_POST['desemail']; //define o login como próprio email dele
...
$app->get("/boleto/:idorder", function($idorder){
	...
	$dadosboleto["demonstrativo1"] = "Pagamento de Compra na Loja Anna K Store E-commerce";
	$dadosboleto["demonstrativo2"] = "Taxa bancária - R$ 0,00";
	$dadosboleto["demonstrativo3"] = "";
	$dadosboleto["instrucoes1"] = "";
	$dadosboleto["instrucoes2"] = "- Receber até 10 dias após o vencimento";
	$dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: storeannak@gmail.com.br";
	$dadosboleto["instrucoes4"] = "&nbsp; Emitido pelo sistema AnnaKStore - www.annakstore.com.br";
...
$app->post("/profile/change-password", function(){
	...
	if (!password_verify($_POST['current_pass'], $user->getdespassword())) {
		...
		User::setMsgError("A senha atual está inválida.");
		header("Location: /profile/change-password");
		exit;			
